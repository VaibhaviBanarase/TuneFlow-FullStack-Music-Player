...
const getSongs=async(req,res)=>{
    try{
      const response=await axios.get(
        `https://api.jamendo.com/v3.0/tracks/?client_id=fdbd6414&format=jsonpretty&limit=15`
      );
...
const getPlaylistingByTag=async(req,res)=>{
    try{
...
export {getSongs,getPlaylistingByTag,toggleFavourites};
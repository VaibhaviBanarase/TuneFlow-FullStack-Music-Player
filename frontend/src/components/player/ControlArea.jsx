...
const handleLike=async()=>{
  ...
  try {
    ...
    const res=await axios.post(`${import.meta.env.VITE_BASE_URL}/api/songs/favourites`,
      {song:songData},
    ...
    <div className="control-root">
      ...
      <div className="control-progress-wrapper">
        <input
          ...
          style={{
            background: `linear-gradient(to right, #a855f7 ${duration ? (currentTime / duration) * 100 : 0}%,#333 #333 ${

...
import logo from "../../assets/tuneflow-logo.png";
    ...
    <>
      <aside className="sidemenu-root">
        ...
        <div className="sidemenu-header">
          <img src={logo} alt="tuneflow-logo" className="sidemenu-logo-img" />
          <h2 className="sidemenu-logo-title">TuneFlow</h2>
        </div>
        {/* Navigation */}
        <nav className="sidemenu-nav" aria-label="Main navigation">
          <ul className="sidemenu-nav-list">
            ...
            <li>
              <button
                className={getNavBtnClass("favourites")}
